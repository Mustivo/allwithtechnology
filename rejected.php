...
<body>
	...
	<div class="mt-5" style="background-color: rgba(255, 255, 255, 0.973);">
		<div class="container col-sm-12 pt-5">
			<h1 class="text-center font-italic font-weight-bold pb-3 small">Rejected_User Information</h1>
            <table class="table table-bordered table-hover table-responsive">
                ...
                $x=1;
                $select = mysqli_query($con,"SELECT * FROM rejected_user");
                while($rows=mysqli_fetch_array($select)){
                    ...
                    <tr>
                        ...
                        <td><a href="delete2.php?link=<?php echo $rows['reject_id']?>" class="text-warning small">Delete</a></td>
                    </tr>
                    <?php
                    $x++;
