...
<body>
	...
	<div class="link jumbotron-fluid fixed-top font-weight-bold">
		...
		<div class="pl-5 col-sm-12 pt-5">
			<h3 class="text-center text-light" style="font-size: 50px; padding-top: 150px;">Announcement</h3>
	...
	<div class="at" style="background-color: rgba(255, 255, 255, 0.973);">
		<div class="container pt-3 col-sm-12" style="margin-top: 190px">
			<h6 class='text-center font-weight-bold pb-3'>Announcement</h6>
            <div class="pb-3">
				<?php
				...
				<div class="col-sm-2">
					...
					echo "<h1 class='text-center font-italic font-weight-bold pb-3 small'>Not Found</h1>";
				}
