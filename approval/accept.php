...
<body>
		<div class="link jumbotron-fluid fixed-top font-weight-bold">
				<div class="two col-sm-12 container d-flex pb-3">
					...
					<div class="col-sm-9 link1 d-flex pt-3 justify-content-center">
					<div class="dropdown1">
                ...
                <a href="logout1.php" class="nav nav-link">Logout</a>
				</div>
					</div>
				</div>
				<div class="col-sm-3 pt-3">
					<span class="wo font-weight-bold text-light"><?php echo $_SESSION["username"]?></span>
					<div class="dropdown">
					<button onclick="myFunction()" class="dropbtn btn btn-outline-warning">&#9776;</button>
    ...
    ?>
                ...
                <h1 class="text-center font-italic font-weight-bold pb-2 small">Text Anyone to Accept IAP Program</h1>
                    ...
                    <textarea name="message" id="" cols="20" rows="8" placeholder="text the approvement message" class="form-control border-warning" required></textarea>
                    ...
                    <input type="text" name="task" value="Accepted" hidden>
                    <button type="submit" name="send" class="btn btn-warning mt-3 w-100">Send</button>
                </form>
				<?php
				require "connection.php";
				if(isset($_POST['send'])){
					...
					mysqli_query($con,"INSERT INTO accepted_user VALUES('','$fname','$lname','$phone','$email','$school','$trade','$level',NOW(),'$task')");
