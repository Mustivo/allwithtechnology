...
<head>
	...
	<title>AWTECH | Application Portal</title>
...
<body>
	<div class="as"></div>
		...
		<div class="pl-5 col-sm-12 pt-5">
			<h3 class="text-center text-light" style="font-family: 'pristina'; font-size: 50PX; padding-top: 150px;">Application Portal</h3>
	...
	<div class="at" style="background-color: rgba(255, 255, 255, 0.973);">
		<div class="container col-sm-12 pt-5">
			...
			?>
				<div class="row">
				<div class="col-sm-6">
					<h3 class="font-italic font-weight-bold">Computer Training</h3>
					<img src="img/Internet Security _ Cyber Security Awareness.jpg" class="w-100 h-75 rounded" alt="">
				</div>
			...
			<button type="submit" class="btn btn-outline-warning w-50 mb-5"><a href="applicationform.php?user=<?php echo $rows['userid']?>" style="text-decoration: none; color: black;">Apply Now</a></button>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-6">
					<h3 class="font-italic font-weight-bold">Industrial Attachment Program</h3>
					<img src="img/Download Desktop source code and Wallpaper by coding and programming_ for free.jpg" class="w-100 h-75 rounded" alt="">
				</div>
				<div class="col-sm-6 mt-5">
					<span class="font-weight-bold">All With Technology (AWTECH)</span>, is a tech company that provides different
			IT services including Computer training, industrial attachment in Software
			...
			<div class="row">
				<div class="col-sm-6">
					<h3 class="font-italic font-weight-bold">Offers Digital Agent Services</h3>
					<img src="img/2.jpg" class="w-100 h-75 rounded" alt="">
				</div>
				<div class="col-sm-6 mt-5">
					<span class="font-weight-bold">All With Technology (AWTECH)</span>, is a tech company that provides different
			IT services including Computer training, industrial attachment in Software
