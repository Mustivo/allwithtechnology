...
<body>
    ...
    ?>
                <form action="./approval/send.php" method="POST"  class="col-sm-7 mb-4 border px-4 pb-3">
                ...
                <h1 class="text-center font-italic font-weight-bold pb-2 small">Text Anyone to Accept IAP Program</h1>
                    ...
                    <input type="text" name="telephone" value="<?php echo $rows['phone']?>" hidden>
                    <input type="text" name="school" value="<?php echo $rows['school']?>" hidden>
