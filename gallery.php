...
<body>
	...
	<div class="link jumbotron-fluid fixed-top font-weight-bold">
		...
		<div class="pl-5 col-sm-12 pt-5">
			<h3 class="text-center text-light" style="font-family: 'pristina'; font-size: 50PX; padding-top: 150px;">Gallery</h3>
		<p class="text-center text-light">We can get in to talk....</p>
		</div>
	<div class="at" style="background-color: rgba(255, 255, 255, 0.973);">
		<div class="container pt-5">
			<h1 class="text-center font-italic font-weight-bold pb-5">Gallery in AWTECH</h1>
			<div class="col-sm-12 mb-5">
				<div class="row">
                    <div class="col-sm-4 mb-5">
                    <img src="img/3.jpeg" class="w-100 rounded" alt="">
                    </div>
                    <div class="col-sm-4 mb-5">
                    <img src="img/5.jpeg" class="w-100 rounded" alt="">
                    </div>
                    <div class="col-sm-4 mb-5">
                    <img src="img/5.jpeg" class="w-100 rounded" alt="">
                    </div>
                    <div class="col-sm-4 mb-5">
                    <img src="img/6.jpeg" class="w-100 rounded" alt="">
                    </div>
                    <div class="col-sm-4 mb-5">
                    <img src="img/0.jpeg" class="w-100 rounded" alt="">
                    </div>
                    <div class="col-sm-4">
                    <img src="img/11.jpeg" class="w-100 rounded" alt="">
                    </div>
                    </div>
			</div>
