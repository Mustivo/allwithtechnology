...
<body>
	...
	<div class="link jumbotron-fluid fixed-top font-weight-bold">
		...
		<div class="pl-5 col-sm-12 pt-5">
			<h3 class="text-center text-light" style="font-family: 'pristina'; font-size: 50PX; padding-top: 150px;">Contact Us</h3>
	...
	<div class="at" style="background-color: rgba(255, 255, 255, 0.973);">
		<div class="container pt-5">
			...
			<div class="col-sm-12 mb-5">
				<iframe class="paa" src="https://www.google.com/maps/embed?pb=!4v1711703574593!6m8!1m7!1s3v8oJs7lzNyp3ovXBp-T_A!2m2!1d-2.073286751188435!2d29.75198201284556!3f342.9986395764612!4f-4.713202810427532!5f0.7820865974627469" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
			</div>
				...
				<div class="col-sm-4">
                    ...
                    <p class="font-weight-bold mt-2">Email:<br>
                        ...
                        <p class="font-weight-bold mt-2">Call:<br>
                            <span class="text-dark small">+250 786974250</span></p>
                </div>
                <div class="col-sm-8">
