...
<body>
	...
	<div class="mt-5" style="background-color: rgba(255, 255, 255, 0.973);">
		<div class="container col-sm-12 pt-5">
			<h1 class="text-center font-italic font-weight-bold pb-3 small">User_Detail Information</h1>
            <table class="table table-bordered table-hover table-responsive">
                <tr>
                    ...
                    <th class="text-warning">Phone Numbe</th>
                    <th class="text-warning">School Name</th>
                    <th class="text-warning">Trade</th>
                    <th class="text-warning">Level</th>
                    <th class="text-warning">Application Letter</th>
                    <th class="text-warning">School License</th>
                    <th class="text-warning">School Report</th>
                ...
                while($rows=mysqli_fetch_array($select)){
                    ...
                    <tr>
                        ...
                        <td><?php echo $rows['app_letter']?><a href="img/<?php echo $rows['app_letter']?>" class="text-warning small" download>Download</a></td>
                        <td><?php echo $rows['licence_doc']?><a href="img/<?php echo $rows['app_letter']?>" class="text-warning small" download>Download</a></td>
                        <td><?php echo $rows['report_doc']?><a href="img/<?php echo $rows['app_letter']?>" class="text-warning small" download>Download</a></td>
                        <td><?php echo $rows['date_time']?></td>
                        <td><a href="accept.php?link=<?php echo $rows['userd_id']?>" class="text-warning small">Accept</a></td>
                        <td><a href="reject.php?link=<?php echo $rows['userd_id']?>" class="text-warning small">Decline</a></td>
                    </tr>
                    <?php
                    $x++;
